...
#'   \item \code{a_layer}: add new a_layer
#'   \item \code{a_theme}: update plot theme
#'   \item \code{a_scale}: replace current a_scale
...
#'
#' p
#' p + ggplot2Animint:::a_coord_cartesian(ylim = c(0, 40))
