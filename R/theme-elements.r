...
a_element_render <- function(a_theme, a_element, ..., name = NULL) {
  ...
  # Get the element from the a_theme, calculating inheritance
...
#'
#' @param a_element Theme element, i.e. \code{a_element_rect} or similar.
...
# Check that an a_element object has the proper class
#
