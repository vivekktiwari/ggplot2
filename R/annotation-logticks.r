...
#'  a_theme_bw()
#'
#' a + ggplot2Animint:::a_annotation_logticks()                # Default: log ticks on bottom and left
#' a + ggplot2Animint:::a_annotation_logticks(sides = "lr")    # Log ticks for y, on left and right
#' a + ggplot2Animint:::a_annotation_logticks(sides = "trbl")  # All four sides
#'
#' # Hide the minor grid lines because they don't align with the ticks
#' a + ggplot2Animint:::a_annotation_logticks(sides = "trbl") +
#' a_theme(panel.grid.minor = a_element_blank())
#'
...
#'
#' b + ggplot2Animint:::a_annotation_logticks()
#'
#' # Using a coordinate transform requires scaled = FALSE
#' t <- a_plot(msleep, a_aes(bodywt, brainwt)) +
#'   a_geom_point() +
#'   ggplot2Animint:::a_coord_trans(x = "log10", y = "log10") +
#'   a_theme_bw()
#' t + ggplot2Animint:::a_annotation_logticks(scaled = FALSE)
#'
#' # Change the length of the ticks
#' a + ggplot2Animint:::a_annotation_logticks(
#'   short = unit(.5,"mm"),
#'   mid = unit(3,"mm"),
#'   long = unit(4,"mm")
#' )
