...
#' p + ggplot2Animint:::a_annotate("text", x = 4, y = 25, label = "Some text")
#' p + ggplot2Animint:::a_annotate("text", x = 2:5, y = 25, label = "Some text")
...
#'   colour = "red", size = 1.5)
#'
#' p + ggplot2Animint:::a_annotate("text", x = 2:3, y = 20:21, label = c("my label", "label 2"))
