...
#' p + geom_violin() + ggplot2Animint:::a_coord_flip()
#'
...
#' m + geom_violin() + ggplot2Animint:::a_coord_trans(y = "log10")
#' m + geom_violin() + a_scale_y_log10() + ggplot2Animint:::a_coord_trans(y = "log10")
#'
