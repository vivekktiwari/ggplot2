...
#' p + a_geom_violin() + ggplot2Animint:::a_coord_flip()
#'
...
#' m + a_geom_violin() + ggplot2Animint:::a_coord_trans(y = "log10")
#' m + a_geom_violin() + a_scale_y_log10() + ggplot2Animint:::a_coord_trans(y = "log10")
#'
#' # Violin plots with continuous x:
#' # Use the group a_aesthetic to group observations in violins
