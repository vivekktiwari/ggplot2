...
a_Scale <- a_ggproto("a_Scale", NULL,
                 ...
                 # @seealso \code{\link{a_scale_train}} for scale specific generic method
...
#'   discrete variables.
#' @param a_guide Name of guide object, or object itself.
#' @export
continuous_a_scale <- function(a_aesthetics, a_scale_name, palette, name = waiver(),
...
#' @export
discrete_a_scale <- function(a_aesthetics, a_scale_name, palette, name = waiver(), breaks = waiver(),
