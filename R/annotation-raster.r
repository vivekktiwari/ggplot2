...
#'   a_geom_point() +
#'   ggplot2Animint:::a_annotation_raster(rainbow, 15, 20, 3, 4)
#' # To fill up whole plot
#' a_plot(mtcars, aes(mpg, wt)) +
#'   ggplot2Animint:::a_annotation_raster(rainbow, -Inf, Inf, -Inf, Inf) +
#'   a_geom_point()
#'
#' rainbow2 <- matrix(hcl(seq(0, 360, length.out = 10), 80, 70), nrow = 1)
#' a_plot(mtcars, aes(mpg, wt)) +
#'   ggplot2Animint:::a_annotation_raster(rainbow2, -Inf, Inf, -Inf, Inf) +
#'   a_geom_point()
#' rainbow2 <- matrix(hcl(seq(0, 360, length.out = 10), 80, 70), nrow = 1)
#' a_plot(mtcars, aes(mpg, wt)) +
#'   ggplot2Animint:::a_annotation_raster(rainbow2, -Inf, Inf, -Inf, Inf, interpolate = TRUE) +
#'   a_geom_point()
